				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="news.php">Berita</a></li>
			...
			<main class="main-content">
				...
				<div class="page">
					<div class="container">
						...
						<ul class="news-list">
							<li>
								<figure><img src="poto/hamokdiskon1(270).png" alt=""></figure>
								<h3 class="entry-title"><a href="login.php">Hamok</a></h3>
						...
						<h2 class="section-title">Mei</h2>
						<ul class="news-list">
							<li>
								<figure><img src="poto/brisemeru1(270).png" alt=""></figure>
								<h3 class="entry-title"><a href="beritasemeru.php">Kebijakan Baru Gunung Semeru</a></h3>
								<div class="date">12.05.2019</div>
								<p>Balai Besar Taman Nasional Bromo Tengger Semeru (BB TNBTS) membuka kembali Gunung Semeru untuk jalur pendakian mulai 12 Mei 2019 ini. Seiring pembukaan jalur pendakian itu, ada kebijakan baru yang turut ditetapkan pengelola taman nasional tersebut.</p>
							</li>
						</ul>
					</div>
				</div> <!-- .page -->
