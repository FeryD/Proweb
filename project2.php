				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="project2.php">Fasilitas</a></li>
							<li class="menu-item"><a href="contact2.php">HikeGram</a></li>
							<li class="menu-item"><a href="#">Fery</a></li>
						</ul> <!-- .menu -->
					</div> <!-- .main-navigation -->
					...
					<div class="container">
						...
						<div class="filterable-items">
							...
							<div class="project-item filterable-item sewabarang">
								<figure class="featured-image">
									<a href="pembeli.php"><img src="poto/hamok.png" alt="#"></a>
									<figcaption>
							...
							<div class="project-item filterable-item sewabarang">
								<figure class="featured-image">
									<a href="pembeli.php"><img src="poto/tasgunung.png" alt="#"></a>
									<figcaption>
							...
							<div class="project-item filterable-item sewabarang">
								<figure class="featured-image">
									<a href="pembeli.php"><img src="poto/kompor.png" alt="#"></a>
									<figcaption>
							...
							<div class="project-item filterable-item sewabarang">
								<figure class="featured-image">
									<a href="pembeli.php"><img src="poto/tenda.png" alt="#"></a>
									<figcaption>
							...
							<div class="project-item filterable-item tiket">
								<figure class="featured-image">
									<a href="pembeli.php"><img src="poto/tiketbromo.png" alt="#"></a>
									<figcaption>
